    ...
    <div id="heroCarousel" data-bs-interval="5000"  >
      ...
      <div class="carousel-inner" role="listbox">-->
        ...
        <div class="carousel-item active" style="background-image: url(assets/img/slide/slide-1.jpg)">
          <!--<div class="container">
            <h2>Welcome to <span>Medical Equipments</span></h2> 
    ...
    <section id="cta" class="cta">
      <div class="container" data-aos="zoom-in">
        ...
        <div class="text-center">
          ...
          <a class="cta-btn scrollto" href="#appointment">Make an Query</a>
        </div>
        ...
        <div class="row no-gutters">
          ...
          <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
            <div class="count-box">
              ...
              <p><strong>Meet Our Team</strong> consequuntur quae qui deca rode</p>
    ...
    <section id="appointment" class="appointment section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <form action="forms/appointment.php" method="post" role="form" class="php-email-form" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="text-center"><button type="submit">Make an Query</button></div>
        </form>
        ...
        <div class="row mt-5">
          ...
          <div class="col-lg-6">
            ...
            <div class="row">
              ...
              <div class="col-md-6">Uttar Pardesh
                <div class="info-box mt-4">
                  <i class="bx bx-phone-call"></i>
                  <h3>Call Us</h3>
                  <p>012-24242424<br>0120-24242424</p>
                </div>
              </div>
            </div>
